...
def process_page(session_id):
    ...
    initial_url = f'https://www.publicnoticecolorado.com/(S({session_id}))/Details.aspx?SID={session_id}&ID=90898'
    ...
    # if "Please Note:" in initial_response.text and "I agree to the Terms of Use" in initial_response.text:
    #     print("Session expired, getting new session ID...")
    #     new_session_id = get_fresh_session()
    #     return process_page(new_session_id)
    ...
    if g_response and g_response != 0:
        ...
        # if "Please Note:" in final_response.text and "I agree to the Terms of Use" in final_response.text:
        #     print("Session expired after submission, getting new session ID...")
        #     new_session_id = get_fresh_session()
        #     return process_page(new_session_id)
        ...
        with open('90898.html', 'w', encoding='utf-8') as f:
            f.write(final_response.text)
        print("\nHTML content saved to page_content.html")
